...
* using EMP framework.
*
*  Example from Section 3.4.2.6 - Nash-Cournot Model of Three Firms
...
* -----------------------------------------------------------------------
* Define and solve a Nash game where all firms are price-takers.
* -----------------------------------------------------------------------

EQUATION objdef_cournot_nash(i) "objective definition of firm i for Cournot-Nash game";
EQUATION demand                         "market demand";


objdef_cournot_nash(i)..
    obj(i)
        =E=
    sum(b, C(i,b)*x(i,b) - (alpha - beta*sum((ii,bb), x(ii,bb)))*x(i,b));


MODEL CournotNash / objdef_cournot_nash /;

PUT empinfo 'equilibrium';
loop(i,
    PUT / 'min', obj(i);
    loop(b, PUT x(i,b));
    PUT objdef_cournot_nash(i);
        );
PUTCLOSE empinfo;
...
* -----------------------------------------------------------------------
* equilibrium
* min obj('i1') x('i1','b1') x('i1','b2') objdef_cournot_nash('i1')
* min obj('i2') x('i2','b1') x('i2','b2') objdef_cournot_nash('i2')
* min obj('i3') x('i3','b1') x('i3','b2') objdef_cournot_nash('i3')
* -----------------------------------------------------------------------
