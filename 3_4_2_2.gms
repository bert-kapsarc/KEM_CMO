...
* using EMP framework.
*
*  Example from Section 3.4.2.2 - Three Price-Taking Firms
...
EQUATION objdef_nash(i) "objective definition of firm i for Nash game";
...
objdef_nash(i)..
    obj(i)
        =E=
        sum(b, C(i,b)*x(i,b) - (alpha - beta*q)*x(i,b));
...
* -----------------------------------------------------------------------
* equilibrium
* min obj('i1') x('i1','b1') x('i1','b2') objdef_nash('i1')
* min obj('i2') x('i2','b1') x('i2','b2') objdef_nash('i2')
* min obj('i3') x('i3','b1') x('i3','b2') objdef_nash('i3')
* vi demand q
* -----------------------------------------------------------------------
