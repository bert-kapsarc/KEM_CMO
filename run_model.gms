...
*$ontext
         ...
         reserve_capacity(r) = sum((i,h),Cap_avail.l(i,h,r))/smax((e,l),sum((s,ss),EL_demand(r,e,l,s,ss)*prob(s,ss)))-1;
;



profit(i)=sum((h,r,e,l,s,ss),prob(s,ss)*(price.l(r,e,l,s,ss)-mc(h,r,s,ss))*q.l(i,h,r,e,l,s,ss)*d(e,l))-sum((h,r),ici(h)*Cap_avail.l(i,h,r))-sum((h,r),icr(h)*ret.l(i,h,r))+sum((r,e,m,h),delta.l(r,e,m)*beta(h,r,m)*Cap_avail.l(i,h,r));
...
****capacity usage
cus(i)=sum((r,e,l,h,s,ss),prob(s,ss)*d(e,l)*q.l(i,h,r,e,l,s,ss))/sum((l,h,r,e,s,ss),prob(s,ss)*d(e,l)*Cap_avail.l(i,h,r));

****return on production
rop(i)=profit(i)/sum((r,e,l,h,s,ss),prob(s,ss)*d(e,l)*q.l(i,h,r,e,l,s,ss));
