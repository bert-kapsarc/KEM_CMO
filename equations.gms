...
Eq1(r,e,l,s)..    price(r,e,l,s)=e=
                     ...
                     +b(r,e,l,s)*(sum(rr,arbitrage(r,rr,e,l,s))-sum(rr,arbitrage(rr,r,e,l,s))) ;
...
Eq9_2(r,rr,e,l,s)..   price_trans(r,rr,e,l,s)-phi(r,rr)-tau(r,rr,e,l,s)/d(e,l)
*                         -shadows_trans_balance(r,rr,e,l,s)
                                 =e=0
;

Eq9_3(r,rr,e,l,s)..   kind_trans0(r,rr)-trans(r,rr,e,l,s)=g=0;
Eq9_4(r,rr,e,l,s)..   sum(i,trade(i,r,rr,e,l,s))+arbitrage(r,rr,e,l,s)-trans(r,rr,e,l,s)=e=0;
...
Eq_arb(r,rr,e,l,s)       .. arbitrage(r,rr,e,l,s)=g=0;
