...
Equations
         ...
         Eq2(r,e,l)                Equation (2)
         Eq9_1(company,h,f,r,e,l,s,ss)
         Eq9_2(company,h,r)
         Eq9_3(company,h,r)
         Eq9_4(company,h,r,rr,e,l,s,ss)
...
Eq1(r,e,l,s,ss)..    price(r,e,l,s,ss)=e=
                     ...
                     (sum((j)$(not gttocc(h)),sales(j,r,e,l,s,ss))
...
Eq9_4(i,r,rr,e,l,s,ss)$(trading=1 and r_trade(r,rr) and not legacy(i) and not gttocc(h))..
